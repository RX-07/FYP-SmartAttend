import{t as s,n as g,l as m,o as f,d as b,f as p}from"./toastr.min-MdK85Wuf.js";/* empty css               */import"./Header-D0zNWYaT.js";s.options.positionClass="toast-bottom-right";const u=g();function j(){const n=m(u,"Students");f(n,e=>{const o=document.querySelector(".approval-table tbody");o.innerHTML="",e.forEach(t=>{const r=t.data(),l=t.id,a=r.enrolledSubjects;a&&typeof a=="object"?Object.entries(a).forEach(([c,d])=>{if(d&&d.status==="Submitted for approval"){const i=document.createElement("tr");i.innerHTML=`
                            <td>${r.studentID}</td>
                            <td>${c}</td>
                            <td>${d.name}</td>
                            <td>
